...
# runs its action (which is to call "make dmc")
# ---------------------------------------------
all: 
	make dmc
...
# compiler. Note here the difference with the dmc rule:
...
# Run the program on test1.dm, writing the
...
# ---------------------------------------------
test: all
	./dmc test1.dm -t test1.out 2> test1.err
	diff --strip-trailing-cr test1.out test1.out.expected
	diff --strip-trailing-cr test1.err test1.err.expected
	./dmc test2.dm -t test2.out 2> test2.err
	diff --strip-trailing-cr test2.out test2.out.expected
	diff --strip-trailing-cr test2.err test2.err.expected
	./dmc test3.dm -t test3.out 2> test3.err
	diff --strip-trailing-cr test3.out test3.out.expected
	diff --strip-trailing-cr test3.err test3.err.expected
	./dmc test4.dm -t test4.out 2> test4.err
	diff --strip-trailing-cr test4.out test4.out.expected
	diff --strip-trailing-cr test4.err test4.err.expected
	./dmc test5.dm -t test5.out 2> test5.err
	diff --strip-trailing-cr test5.out test5.out.expected
	diff --strip-trailing-cr test5.err test5.err.expected
	./dmc test6.dm -t test6.out 2> test6.err
	diff --strip-trailing-cr test6.out test6.out.expected
	diff --strip-trailing-cr test6.err test6.err.expected
	./dmc test7.dm -t test7.out 2> test7.err
	diff --strip-trailing-cr test7.out test7.out.expected
	diff --strip-trailing-cr test7.err test7.err.expected
	./dmc test8.dm -t test8.out 2> test8.err
	diff --strip-trailing-cr test8.out test8.out.expected
	diff --strip-trailing-cr test8.err test8.err.expected
	./dmc test9.dm -t test9.out 2> test9.err
	diff --strip-trailing-cr test9.out test9.out.expected
	diff --strip-trailing-cr test9.err test9.err.expected
...
cleantest:
	...
	rm -f test3.out test3.err
	rm -f test4.out test4.err
	rm -f test5.out test5.err
	rm -f test6.out test6.err
	rm -f test7.out test7.err
	rm -f test8.out test8.err
	rm -f test9.out test9.err
